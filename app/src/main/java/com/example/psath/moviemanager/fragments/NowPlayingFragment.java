package com.example.psath.moviemanager.fragments;
...
import com.example.psath.moviemanager.adapters.Movie_RecycleView_Adapter;
...
public class NowPlayingFragment extends Fragment {
    ...
    @BindView(R.id.npMovies)
    RecyclerView npMovies;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        npMovies.setHasFixedSize(true);
        npMovies.setLayoutManager(llm);

        Movie_RecycleView_Adapter adapter = new Movie_RecycleView_Adapter(getContext(),movies);
        npMovies.setAdapter(adapter);
